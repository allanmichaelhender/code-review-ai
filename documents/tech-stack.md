...
| LLM Provider   | OpenRouter API                | -                     | AI-powered code analysis (repository)  |
| LLM Provider   | Google Gemini API             | -                     | AI-powered code analysis (single file) |
| LLM Model      | NVIDIA Nemotron-3 Nano 30B    | free tier             | Repository analysis model              |
| LLM Model      | Gemini 3.1 Flash Lite Preview | -                     | Single file analysis model             |
